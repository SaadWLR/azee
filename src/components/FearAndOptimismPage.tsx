...
function SignalCard({ signal }: { signal: SentimentSignal }) {
  ...
  return (
    <li className="rounded-3xl border border-white/12 bg-[rgb(var(--azee-panel))] p-6">
      ...
      {live ? (
        <>
          <p className="mt-5 text-3xl font-bold leading-none tabular-nums tracking-tight text-[rgb(var(--azee-chalk))]">
            {signal.score}
          </p>
...
function StatCard({
  ...
  return (
    <div className="rounded-2xl border border-white/12 bg-[rgb(var(--azee-panel))] px-5 py-4">
      ...
      <p className="mt-2 text-2xl font-bold leading-none tabular-nums tracking-tight text-[rgb(var(--azee-chalk))]">
        {value}
      </p>
      {zone ? (
        <p
    ...
    <main className="min-h-screen text-white">
          ...
          {error ? (
            ...
            <>
              ...
              {index?.score !== undefined ? (
                <>
                  <p className="-mt-2 text-5xl font-bold leading-none tabular-nums tracking-tight text-[rgb(var(--azee-chalk))] sm:text-6xl">
                    {index.score}
                  </p>
                  <div className="mt-4">
      ...
      >
        <div className="mx-auto max-w-6xl">
          ...
          <h2 className="mt-6 max-w-3xl text-2xl font-bold tracking-tight text-[rgb(var(--azee-navy))] sm:text-3xl">
      ...
      >
        <div className="mx-auto max-w-3xl">
          ...
          <h2 className="mt-6 text-2xl font-bold tracking-tight text-[rgb(var(--azee-navy))] sm:text-3xl">
            Common questions
          </h2>
